...
Route::middleware(['middleware'=>'auth'])->group(function(){
  ...
  Route::post('conference-detail',[SettingController::class, 'getConferences'])->name('get.conference.detail');
...
Route::get('/Inscription-conference-oide', [SettingController::class, 'ajoutInscritForm'])->name('inscription');
