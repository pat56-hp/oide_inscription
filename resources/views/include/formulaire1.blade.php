<style>
    ...
    /* Style pour la section des lieux touristiques */
          ...
          #siteDetails p#sitePrice {
            color: #007bff;
          }

          /* CSS styles for the selected sites section */
        	         ...
        	         <div class="card mx-auto container-fluid p-0 border-0" >
                            ...
                            <div class="container mt-5">
                              <form role="form" action="{{route('ajouter.inscrit')}}" method="post" enctype="multipart/form-data" id="inscription-form">
                                ...
                                <div class="row">
                                      ...
                                      <div class="form-section">
                                        <div class="form-group">
                                          ...
                                          <select class="form-control" name="civilite">
                                            ...
                                            <option value="Madémoiselle">Madémoiselle</option>
                                          </select>
                                          <span class="text-danger error-text civilite_error"></span>
                                        </div>
                                        <div class="form-group">
                                          <label>Nom</label>
                                          <input type="text" class="form-control" style="text-transform: uppercase" name="nom" placeholder="Entrez votre nom">
                                          <span class="text-danger error-text nom_error"></span>
                                        </div>
                                        <div class="form-group">
                                          <label>Prénoms</label>
                                          <input type="text" class="form-control" name="prenoms" style="text-transform: uppercase" placeholder="Entrez votre prénom">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="radio">
                                             <label>
                                               <input type="radio" name="genre" id="optionsRadios1" value="Homme" checked>
                                               Homme
                                             </label>
                                        ...
                                        <div class="form-group">
                                          <label>Langue de communication</label>
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="radio">
                                                  <label>
                                                    <input type="radio" name="inscription_tant_que" id="optionsRadios3" value="Intervenant" checked>
                                                    Intervenant
                                                  </label>
                                                  <label style="margin:10px">
                                                    <input type="radio" name="inscription_tant_que" id="optionsRadios4" value="Participant">
                                                    Participant
                                                  </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        ...
                                        <select name="conferences" id="conferences">
                                          <option value="0" disabled="true">Sélectionnez les conférences...</option>\
                                        </select>
                                      </div>
                                    </div>
                                    <!-- Tourist Site Section in a Separate Block -->
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label>Voulez-vous visiter un lieu touristique lors de votre séjour ?</label>
                                        <div class="radio">
                                          <label>
                                            <input type="radio" name="visit_tourist_site" value="oui" onclick="showTouristSection()">
                                            Oui
                                          </label>
                                          <label style="margin:10px">
                                            <input type="radio" name="visit_tourist_site" value="non" onclick="hideTouristSection()" checked>
                                            Non
                                          </label>
                                        </div>
                                      </div>
                                ...
                                <div class="col-md-6">
                                  <div id="touristSection" class="text-center" style="display:none;">
                                    <div class="form-group">
                                      <label for="tourist_site">Lieux Touristiques</label>
                                    ...
                                    <input type="hidden" id="selected_sites_data" name="selected_sites_data">
                                  ...
                                  <button type="submit" id="submitButton1" class="btn btn-primary btn-block mt-4" style="float:right;">S'INSCRIRE</button>
                              </form>
                            </div>
                    	 </div>
        	          </div>
...
function showSelectedSites() {
    ...
    for (let option of selectElement.selectedOptions) {
        ...
        const siteDetailsHtml = `
            <div class="site-detail-block">
                <strong>${siteName}</strong><br>
                <img src="${siteImageSrc}" alt="Image du site" class="img-fluid mt-3"><br>
                <p>${siteDescription}</p>
                <p class="font-weight-bold text-primary">${sitePrice}</p>
            </div>
            <hr noshade>
        `;
...
document.getElementById('submitButton1').addEventListener('click', function(event) {
    ...
    for (let option of selectElement.selectedOptions) {
        // Extract the filename from the data-img attribute
      if (option.value !== '0') {
