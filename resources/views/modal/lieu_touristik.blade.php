...
<div class="modal fade touristik" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title text-center text-primary">
          <strong>LISTE DES LIEU(X) TOURISTIQUE(S) CHOISIS PAR</strong>
        </h4>
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <ul id="tourist-list" class="list-group">
                <!-- Les lieux touristiques seront ajoutés ici -->
              </ul>
            </div>
          </div>
        </div>
